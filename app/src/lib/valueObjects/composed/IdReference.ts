...
export class IdReference<To extends Entity<any>> extends ValueObject<string> {
    ...
    public static validate<S extends EntitySlots, E extends Entity<S>>(value: string, options: IdReferenceOptions<S, E>) {
        // type
     ...
     */
    public static create<S extends EntitySlots, E extends Entity<S>>(value: string, options: IdReferenceOptions<S, E>) {
     ...
     */
    public static fromList<S extends EntitySlots, E extends Entity<S>>(values: string[], options: IdReferenceOptions<S, E>) {
...
export interface IdReferenceOptions<S extends EntitySlots, E extends Entity<S>> extends Partial<CreationOptions> {
