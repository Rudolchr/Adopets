...
export class SafeBoolean extends ValueObject<boolean> {
     ...
     */
    public static validate(value: string | boolean | undefined, options?: SafeBooleanOptions) {
        ...
        safeBoolean = typeof safeBoolean === 'boolean' ? safeBoolean : JSON.parse(safeBoolean) as boolean;
