...
const speciesFilter: HTMLSelectElement = document!.querySelector("#speciesFilter")!;
...
const compatibleWithFilter: HTMLFieldSetElement = document!.querySelector("fieldset[data-bind='compatibleWithFilter']")!;
...
const suitableWithFilter: HTMLFieldSetElement = document!.querySelector("fieldset[data-bind='suitableWithFilter']")!;
...
const housingFilter: HTMLSelectElement = document!.querySelector("#housingFilter")!;
fillSelectWithRange(housingFilter, HousingEnum, []);
housingFilter.addEventListener("change", () => filter());

const shelterFilter: HTMLSelectElement = document!.querySelector("#shelterFilter")!;
