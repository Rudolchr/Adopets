...
const entitySelection = formFactory.createEntitySelection('shelterSelection', ShelterStorage.instances, 'name', formElements);
formFactory.createSubmitButton('saveButton', formElements, (slots) => ShelterStorage.update(slots), entitySelection, 'name');
