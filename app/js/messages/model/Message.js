...
const PET_ID_CONSTRAINTS = {
    name: "Message.shelterId",
    foreignStorage: PetStorage,
};
const SENDER_EMAIL_CONSTRAINTS = {
    name: "Message.senderEmail",
};
const SENDER_PHONE_NO_CONSTRAINTS = {
...
export class Message extends Entity {
    ...
    static checkPetId(petId) {
        return petId
            ? catchValidation(() => IdReference.validate(petId, PET_ID_CONSTRAINTS), "The message's pet does not exist!")
            : "";
    }
    ...
    static checkSenderEmail(senderEmail) {
        return senderEmail
            ? catchValidation(() => EmailAddress.validate(senderEmail, SENDER_EMAIL_CONSTRAINTS), "The message's email address is not legit!")
            : "";
    }
    ...
    static checkSenderPhoneNo(senderPhoneNo) {
        return senderPhoneNo
            ? catchValidation(() => PhoneNumber.validate(senderPhoneNo, SENDER_PHONE_NO_CONSTRAINTS), "The message's phone number is not given or nor in given Format!")
            : "";
    }
